...
CreateEntity(2, MeshID(2), MaterialID(0),  0,  2, -4)
CreateEntity(3, MeshID(0), MaterialID(3), 10,  1, 13)
CreateEntity(5, MeshID(4), MaterialID(2),  0,  0,  0)
CreateEntity(6, MeshID(0), MaterialID(0), 14,  1,  0)

ScaleEntity(3, 8, 1, 1)
RotateEntity(3, 0, 34, 0)
ScaleEntity(5, 0.1, 0.1, 0.1)
