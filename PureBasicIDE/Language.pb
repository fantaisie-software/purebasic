...
DataSection
  ...
  ; ===================================================
  Data$ "Make",                 "Make"
  Data$ "TipRefresh",           "Refresh Current Panel"
  Data$ "TipCopy",              "Copy Code To Clipboard"
  Data$ "TipPaste",             "Paste Clipboard To Tool"
  Data$ "TipClear",             "Clear All"
  ...
  Data$ "Code",                 "Code"
  Data$ "AdHoc",                "Shown Here"
  Data$ "None",                 "None"
  Data$ "Unused",               "Unused"
  Data$ "ToolInactive",         "Tool is not active"
  Data$ "MakeIf",               "If...EndIf"
  Data$ "MakeSelect",           "Select...EndSelect"
  Data$ "MakeProcedure",        "Procedure Skeleton"
  Data$ "MakeTidy",             "Tidy Only"
  Data$ "MakeAdHoc",            "Template Only"
  Data$ "EnumWindow",           "Window Event()"
  Data$ "EnumGadget",           "Gadget EventType()"
  Data$ "TypeGadget",           "Gadget"
  Data$ "TemplateTool",         "Template Tool"
  Data$ "TidyColon",            "Truncate at colon"
  Data$ "TidyEquals",           "Remove assignments"
  Data$ "TidySemiColon",        "Remove comments"
  Data$ "TidyType",             "Remove types"
  Data$ "P1If",                 "Variable"
  Data$ "P1Procedure",          "Module"    
  Data$ "P2Procedure",          "Prefix"   
  Data$ "OptionIf",             "Include 'Else'"
  Data$ "OptionSelect",         "Include 'Default'"
  Data$ "OptionDebug",          "Include debug messages"
  Data$ "OptionToDo",           "Include 'To Do' items"
  Data$ "OptionProcedure",      "Include declarations"
  Data$ "DebugEntered",         "Entered"
  Data$ "DebugExited",          "Exited"
  Data$ "ToDoMissingVariable",  "Add variable name here." 
  Data$ "ToDoMissingModule",    "Add module name here." 
  Data$ "ToDoImplement",        "Implement"
