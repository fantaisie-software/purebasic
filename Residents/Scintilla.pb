...
Structure SCCharacterRange Align #PB_Structure_AlignC
...
Structure SCTextRange Align #PB_Structure_AlignC
  chrg.SCCharacterRange
  *lpstrText
EndStructure

Structure SCTextToFind Align #PB_Structure_AlignC
  chrg.SCCharacterRange
  *lpstrText
  chrgText.SCCharacterRange
EndStructure

Structure SCCharacterRangeFull Align #PB_Structure_AlignC
	cpMin.i
	cpMax.i
EndStructure

Structure SCTextRangeFull Align #PB_Structure_AlignC
	chrg.SCCharacterRangeFull
	*lpstrText
EndStructure

Structure SCTextToFindFull  Align #PB_Structure_AlignC
	chrg.SCCharacterRangeFull
	*lpstrText
	chrgText.SCCharacterRangeFull
EndStructure

Structure SCNotifyHeader Align #PB_Structure_AlignC
  hwndFrom.i
...
Structure SCNotification Align #PB_Structure_AlignC
  nmhdr.SCNotifyHeader
  position.i			;// SCN_STYLENEEDED, SCN_MODIFIED, SCN_DWELLSTART, SCN_DWELLEND
  ch.l            ;// SCN_CHARADDED, SCN_KEY
  modifiers.l     ;// SCN_KEY
  modificationType.l	;// SCN_MODIFIED
  *text               ;// SCN_MODIFIED
  length.i            ;// SCN_MODIFIED
  linesAdded.i        ;// SCN_MODIFIED
  ...
  annotationLinesAdded.i   ;	/ SCN_MODIFIED with SC_MOD_CHANGEANNOTATION
  updated.l                ; // SCN_UPDATEUI
  listCompletionMethod.l   ; // SCN_AUTOCSELECTION, SCN_AUTOCCOMPLETED, SCN_USERLISTSELECTION
	characterSource.l 	     ; // SCN_CHARADDED
EndStructure               

CompilerIf #PB_Compiler_OS <> #PB_OS_Windows
  Structure TextRange Extends SCTextRange : EndStructure
CompilerEndIf
